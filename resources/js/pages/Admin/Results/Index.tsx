    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col bg-white p-6 md:p-12 lg:p-16">
                ...
                <header className="relative mb-12 space-y-4">
                    ...
                    <div className="space-y-2">
                        <p className="text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">
                            Hasil{' '}
                            <span className="text-emerald-500">Ujian.</span>
                        </p>
                ...
                <Card className="overflow-hidden rounded-[2rem] border-none bg-white shadow ring-1 ring-slate-200">
                            ...
                            <table className="w-full min-w-[760px]">
                                <thead>
                                    <tr className="bg-emerald-200 text-slate-900">
                                        <th className="px-4 py-4 text-left text-[10px] font-black tracking-[0.1em] uppercase">
                                            Rank
                                        </th>
                                    ...
                                    {results.data.length > 0 ? (
                                        results.data.map((result, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    {/* RANK */}
                                                    <td className="bg-slate-50/50 px-4 py-5 text-center">
                                                        {rank === 1 ? (
                                                            <Trophy
                                                    ...
                                                    {/* UJIAN */}
                                                    <td className="bg-slate-50/50 px-6 py-5">
                                                        <div className="flex items-center gap-2 text-sm font-bold text-slate-600 italic">
                                                            <GraduationCap
                                                                size={16}
